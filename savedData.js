...
$w.onReady(async function () {
    ...
    .then( (results) =>{
		...
		console.log(results[0].savedUser);
		$w("#text23").text = results[0].title;
		$w("#text24").text = results[0].savedUser;
    });
