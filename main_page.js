...
async function saveData (database) {
    let savedData;
    let savedDataIds = [];
	//Add your code for this event here: 
    // Getting the data
...
export async function testButton_click(event) {
    saveData("averageCodesChange");  
}

export async function saveLinesContributed_click(event) {
    saveData("codeChanged");   
}

export function saveTimelineButton_click(event) {
	saveData("workTimeline");
}
